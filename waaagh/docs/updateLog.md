...
https://github.com/lyflexi/waaagh/releases/tag/v4.1.1

修复了issues:https://github.com/Halfmoonly/waaagh/issues/3
...
### 🚀Waaagh:v4.1.3
thanks my friend's pr : https://github.com/Halfmoonly/waaagh/pull/9
...
此版本修复了Waaagh读取本地bootstrap.yml/yaml中上述配置失效的问题

### 🐞Waaagh:v4.1.6
Waaagh 4.1.5 is binary incompatible with IntelliJ IDEA Ultimate IU-193.7288.26 due to the following problem Method not found . This can lead to NoSuchMethodError exception at runtime.
...
reslove issue #10：https://github.com/Halfmoonly/waaagh/issues/10

        1. 我们更名啦，由Waaagh更名为Waaagh
        2. 极致提升性能，引入CacheManager，管理双边缓存FeignInterface和ApiController
        3. 欢迎Star：https://github.com/Halfmoonly/waaagh

[waaagh-4.1.8.zip](https://github.com/user-attachments/files/19140074/waaagh-4.1.8.zip)
...
### 🚀 Waaagh V5.1.0 更新内容
reslove issue #6：https://github.com/Halfmoonly/waaagh/issues/6


1. 我们又更名啦[笑哭]，由Waaagh更名为Waaagh
...
1. 我们修复了https://github.com/Halfmoonly/waaagh/issues/11，这曾经是个已经被修复但忘记合并至主分支的修复分支：hotfix/main-fix-bootstrap，见：https://github.com/Halfmoonly/waaagh/issues/8
...
1. feat: 合并了来自开发者的一个特性PR：https://github.com/Halfmoonly/waaagh/pull/14 ,支持Restful注解path中的变量或者静态常量的解析（FeignClient和ApiController），感谢@wdhcr
...
invalidated at: see attachment
    ...
    at com.waaagh.utils.AnnotationParserUtils.isFeignInterface(AnnotationParserUtils.java:101)
    at com.waaagh.utils.FeignClassScanUtils.feignsOfPsiClass(FeignClassScanUtils.java:123)
    at com.waaagh.utils.FeignClassScanUtils.scanFeignInterfaces(FeignClassScanUtils.java:107)
    at com.waaagh.provider.C2FLineMarkerProvider.collectNavigationMarkers(Controller2FeignLineMarkerProvider.java:43)
...
```
### 🐞 Waaagh v5.5.2版本修复如下异常
